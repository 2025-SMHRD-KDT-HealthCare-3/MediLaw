...
from app.citations import extract_and_verify, verify_inputs
from app.schemas import VerifyRequest, VerifyResponse, VerifySummary
...
def verify(req: VerifyRequest):
    ...
    summary = VerifySummary(
        total=len(results), verified=verified, failed=len(results) - verified
    )
    return VerifyResponse(output=results, summary=summary, as_of=req.as_of)
