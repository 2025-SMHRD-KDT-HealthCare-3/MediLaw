...
// product 가 HMS 문서검토를 최대 900s 기다리므로(hms_client.DOCUMENT_TIMEOUT), node 는 그보다 커야
// 응답을 끝까지 받아온다. 안 그러면 node 가 먼저 끊어 504가 난다.
const PRODUCT_PROXY_TIMEOUT_MS = positiveNumberEnv('PRODUCT_PROXY_TIMEOUT_MS', 930_000)
const RAG_PROXY_TIMEOUT_MS = positiveNumberEnv('RAG_PROXY_TIMEOUT_MS', 930_000)
